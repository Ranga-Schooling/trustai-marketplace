...
| Share the repository with `quantic-grader`. | Handbook PDF pp. 4, 8 | Required | **PASS** — `quantic-grader` is listed as a repository collaborator (verified 2026-09-12). | Preserve the collaborator entry through submission. |
